...
// ChildTokenMetaData contains all meta data concerning the ChildToken contract.
var ChildTokenMetaData = &bind.MetaData{
...
// Deprecated: Use ChildTokenMetaData.ABI instead.
var ChildTokenABI = ChildTokenMetaData.ABI
...
func bindChildToken(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := ChildTokenMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
