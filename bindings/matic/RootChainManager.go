...
func bindRootChainManager(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(RootChainManagerABI))
	if err != nil {
		return nil, err
	}
...
func (_RootChainManager *RootChainManagerFilterer) FilterMetaTransactionExecuted(opts *bind.FilterOpts) (*RootChainManagerMetaTransactionExecutedIterator, error) {
	...
	logs, sub, err := _RootChainManager.contract.FilterLogs(opts, "MetaTransactionExecuted")
	if err != nil {
		return nil, err
	}
...
func (_RootChainManager *RootChainManagerFilterer) WatchMetaTransactionExecuted(opts *bind.WatchOpts, sink chan<- *RootChainManagerMetaTransactionExecuted) (event.Subscription, error) {
	...
	logs, sub, err := _RootChainManager.contract.WatchLogs(opts, "MetaTransactionExecuted")
	if err != nil {
		return nil, err
	}
