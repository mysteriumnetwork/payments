...
type API interface {
	...
	GetRateCacheWithFallback(ctx context.Context, coins []Coin, vsCurrencies []Currency) (PriceResponse, error)

	// GetRate returns a rate from the exchange skipping cache.
	GetRate(ctx context.Context, coins []Coin, vsCurrencies []Currency) (PriceResponse, error)
	...
	GetRateCache(ctx context.Context, coins []Coin, vsCurrencies []Currency) (PriceResponse, error)
