...
//go:generate go run bindings/abi/abigen.go --githubrepo=mysteriumnetwork/payments-smart-contracts -githubrelease=v0.9.5 --contracts=SafeMathLib.json,MystToken.json,MystDEX.json,ChannelImplementation.json,Registry.json,HermesContract.json,HermesImplementation.json --out=bindings --pkg=bindings
