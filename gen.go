...
//go:generate go run bindings/abi/abigen.go --githubrepo=mysteriumnetwork/payments-smart-contracts -githubrelease=v1.0.0 --contracts=MystToken.json,ChannelImplementation.json,Registry.json,HermesImplementation.json --out=bindings --pkg=bindings
