...
func (r Request) GetMessage() []byte {
	...
	message = append(message, crypto.Pad(crypto.U256(big.NewInt(0).SetUint64(r.Stake)), 32)...)
	message = append(message, crypto.Pad(crypto.U256(big.NewInt(0).SetUint64(r.Fee)), 32)...)
