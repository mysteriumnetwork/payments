...
contract ERC777ERC20BaseToken is IERC20, ERC777BaseToken {
    ...
    function doBurn(address _operator, address _tokenHolder, uint256 _amount, bytes memory _data, bytes memory _operatorData)
        internal
    {
