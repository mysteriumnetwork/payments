...
func (mock *EtherClientMock) SuggestGasTipCap(ctx context.Context) (*big.Int, error) {
	if mock.SuggestGasTipCapFunc == nil {
		panic("EtherClientMock.SuggestGasTipCapFunc: method is nil but EtherClient.SuggestGasTipCap was just called")
	}
	callInfo := struct {
		Ctx context.Context
	}{
...
// Check the length with:
//     len(mockedEtherClient.SuggestGasTipCapCalls())
func (mock *EtherClientMock) SuggestGasTipCapCalls() []struct {
	Ctx context.Context
} {
	var calls []struct {
		Ctx context.Context
